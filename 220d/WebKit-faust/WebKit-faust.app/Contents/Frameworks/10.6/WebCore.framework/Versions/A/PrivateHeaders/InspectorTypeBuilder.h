...
public:
    ...
    public:
        ...
        Builder<STATE | IdSet>& setId(const TypeBuilder::WebGL::TraceLogId& value)
        {
            COMPILE_ASSERT(!(STATE & IdSet), property_id_already_set);
            m_result->setString("id", value);
            return castState<IdSet>();
        ...
        Builder<STATE | CallsSet>& setCalls(PassRefPtr<TypeBuilder::Array<TypeBuilder::WebGL::Call> > value)
        {
