...
#endif
#if ENABLE(MEDIA_SOURCE)
JSC::JSValue jsDOMWindowSourceBufferConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowSourceBufferConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
#if ENABLE(MEDIA_SOURCE)
JSC::JSValue jsDOMWindowSourceBufferListConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowSourceBufferListConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
