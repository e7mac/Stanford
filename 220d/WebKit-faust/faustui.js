...
function FaustJSUI()  {
    ...
    {
       console.log("addButton : name = %s", param.name);
	}
    
    this.addCheckButton = function(param) 
    {
        console.log("addCheckButton : name = %s", param.name);
	}
    
    this.addVerticalSlider = function(param) 
    {
        cconsole.log("addVerticalSlider : name = %s, min = %d, max = %d, default = %d", param.name, param.minValue, param.maxValue, param.defaultValue);
	}
    
    this.addHorizontalSlider = function(param) 
    {
        console.log("addHorizontalSlider : name = %s, min = %d, max = %d, default = %d", param.name, param.minValue, param.maxValue, param.defaultValue);
	}
    
    this.addNumEntry = function(param) 
    {
        console.log("addNumEntry : name = %s, min = %d, max = %d, default = %d", param.name, param.minValue, param.maxValue, param.defaultValue);   
    }

    this.addHorizontalBargraph = function(param) 
    {
        console.log("addHorizontalBargraph : name = %s, min = %d, max = %d", param.name, param.minValue, param.maxValue);
    }
    
    this.addVerticalBargraph = function(param) 
    {
        console.log("addVerticalBargraph : name = %s, min = %d, max = %d", param.name, param.minValue, param.maxValue);
    }
    
    this.declare = function(param, key, value) 
    {
        console.log("declare : name = %s key = %s, value = %s", param.name, key, value);
    }
}
